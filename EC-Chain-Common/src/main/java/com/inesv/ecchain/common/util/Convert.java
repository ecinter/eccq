...
public final class Convert {
    ...
    private static final long[] EC_MULTIPLIERS = {1, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000};
    public static final BigInteger TWO_64 = new BigInteger("18446744073709551616");
    public static final long[] EC_EMPTY_LONG = new long[0];
    public static final byte[] EC_EMPTY_BYTE = new byte[0];
    public static final byte[][] EC_EMPTY_BYTES = new byte[0][];
    public static final String[] EC_EMPTY_STRING = new String[0];
    ...
    public static long parseAccountId(String account) {
        ...
        if (account.startsWith("EC-")) {
            return Crypto.ecRsDecode(account.substring(3));
        } else {
    ...
    public static String rsAccount(long accountId) {
        return "EC-" + Crypto.ecRsEncode(accountId);
    }
    ...
    public static long fromepochtime(int epochTime) {
        return epochTime * 1000L + Constants.EC_EPOCH_BEGINNING - 500L;
    }

    public static int toepochtime(long currentTime) {
        //LoggerUtil.logInfo("date"+(Constants.EC_EPOCH_BEGINNING + 500));
        return (int) ((currentTime - Constants.EC_EPOCH_BEGINNING + 500) / 1000);
    }
    ...
    public static byte[][] nullToEmpty(byte[][] bytes) {
        return bytes == null ? EC_EMPTY_BYTES : bytes;
    }

    public static long[] nullToEmpty(long[] array) {
        return array == null ? EC_EMPTY_LONG : array;
    }
    ...
    public static String readString(ByteBuffer buffer, int numBytes, int maxLength) throws EcNotValidExceptionEc {
        if (numBytes > 3 * maxLength) {
            throw new EcNotValidExceptionEc("Max parameter length exceeded");
        }
    ...
    public static long parseEC(String ec) {
        return parseStringFraction(ec, 8, Constants.MAX_BALANCE_EC);
    }
