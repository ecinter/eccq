...
public final class EC {
    ...
    private static final long[] ECCONSTANTS = {
    ...
    public static byte[] hash(final byte input[]) {
        ...
        while (inputOffset <= inputLength) {
            ...
            for (i = 0; i < 25; ) {
                ...
                state0 = (t9 = state0 ^ (t8 = ((t4 << 1) | (t4 >>> -1)) ^ (t7 = state4 ^ state9 ^ state14 ^ state19 ^ state24))) ^ ((~(t16 = ((t16 = state6 ^ t3) << 44) | (t16 >>> -44))) & (state2 = ((state2 = state12 ^ t6) << 43) | (state2 >>> -43))) ^ ECCONSTANTS[i++];
