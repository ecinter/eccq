...
public final class JSON {
    ...
    public final static JSONStreamAware EMPTY_JSON = prepare(new JSONObject());
    ...
    public static JSONStreamAware prepare(final JSONObject json) {
        return new JSONStreamAware() {
            private final char[] jsonChars = JSON.toECJSONString(json).toCharArray();
            @Override
    ...
    public static String toString(JSONStreamAware jsonStreamAware) {
        ...
        try {
            JSON.writeECJSONString(jsonStreamAware, stringWriter);
        } catch (IOException ignore) {}
        return stringWriter.toString();
    }

    public static String toECJSONString(JSONAware json) {
        if (json == null)
            return "null";
    ...
    public static void writeECJSONString(JSONStreamAware json, Writer writer) throws IOException {
        if (json == null) {
            writer.write("null");
            return;
        }
