...
public class GetVoterPhasedTransactions extends APIRequestHandler {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws EcException {
        ...
        try (H2Iterator<? extends Transaction> iterator = PhasingPoll.getVoterPhasedTransactions(accountId, firstIndex, lastIndex)) {
