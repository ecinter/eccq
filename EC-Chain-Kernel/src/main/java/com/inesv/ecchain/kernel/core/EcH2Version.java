...
import com.inesv.ecchain.kernel.H2.H2Version;
...
class EcH2Version extends H2Version {
    ...
    protected void update(int nextUpdate) {
        switch (nextUpdate) {
            ...
            case 231:
                EcBlockH2.deleteBlocksFromHeight(Constants.EC_PHASING_BLOCK);
            ...
            case 473:
                EcBlockH2.deleteBlocksFromHeight(Constants.EC_SHUFFLING_BLOCK);
                EcBlockchainProcessorImpl.getInstance().scheduleScan(0, false);
                apply(null);
            case 474:
            ...
            case 484:
                EcBlockchainProcessorImpl.getInstance().scheduleScan(Constants.DISTRIBUTION_START - 1, false);
                apply(null);
            case 485:
                EcBlockH2.deleteBlocksFromHeight(Constants.EC_FXT_BLOCK);
                apply(null);
            case 486:
            ...
            case 490:
                return;
            default:
                throw new RuntimeException("EcBlockchain database inconsistent with code, at update " + nextUpdate
