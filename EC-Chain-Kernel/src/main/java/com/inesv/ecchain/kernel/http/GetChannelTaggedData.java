...
public final class GetChannelTaggedData extends APIRequestHandler {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws EcException {
        ...
        try (H2Iterator<BadgeData> data = BadgeData.getData(channel, accountId, firstIndex, lastIndex)) {
            while (data.hasNext()) {
