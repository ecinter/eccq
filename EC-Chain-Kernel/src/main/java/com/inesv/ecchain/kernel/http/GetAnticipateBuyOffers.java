...
public final class GetAnticipateBuyOffers extends APIRequestHandler {

    static final GetAnticipateBuyOffers instance = new GetAnticipateBuyOffers();
    ...
    private GetAnticipateBuyOffers() {
