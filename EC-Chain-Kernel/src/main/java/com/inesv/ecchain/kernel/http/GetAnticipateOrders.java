...
public final class GetAnticipateOrders extends APIRequestHandler {

    static final GetAnticipateOrders instance = new GetAnticipateOrders();
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws EcException {
        ...
        Filter<Transaction> filter = transaction -> {
            if (transaction.getTransactionType() != ColoredCoins.ASK_ORDER_PLACEMENT) {
                return false;
            }
