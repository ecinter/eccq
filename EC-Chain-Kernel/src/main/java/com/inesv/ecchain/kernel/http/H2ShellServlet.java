...
public final class H2ShellServlet extends HttpServlet {
    ...
    private static final String header =
            "<!DOCTYPE html>\n" +
                    ...
                    "<head>\n" +
                    "    <meta charset=\"UTF-8\"/>\n" +
                    "    <title>Ec H2 Database Shell</title>\n" +
    ...
    private static final String errorNoPasswordIsConfigured =
            "This page is password-protected, but no password is configured in ec.properties. " +
                    "Please set ec.adminPassword or disable the password protection with ec.disableAdminPassword";
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try (PrintStream out = new PrintStream(resp.getOutputStream())) {
            ...
            try {
                ...
                shell.setErr(out);
                shell.setOut(out);
                shell.runTool(H2.H2.getConnection(), "-sql", line);
