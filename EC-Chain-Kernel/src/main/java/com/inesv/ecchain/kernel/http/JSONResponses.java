...
public final class JSONResponses {
    ...
    public static final JSONStreamAware INCORRECT_ALIAS_LENGTH = incorrect("alias", "(length must be in [1.." + Constants.EC_MAX_ALIAS_LENGTH + "] range)");
    ...
    public static final JSONStreamAware INCORRECT_URI_LENGTH = incorrect("uri", "(length must be not longer than " + Constants.EC_MAX_ALIAS_URI_LENGTH + " characters)");
    ...
    public static final JSONStreamAware INCORRECT_ASSET_DESCRIPTION = incorrect("description", "(length must not exceed " + Constants.EC_MAX_ASSET_DESCRIPTION_LENGTH + " characters)");
    public static final JSONStreamAware INCORRECT_ASSET_NAME = incorrect("name", "(must contain only digits and latin letters)");
    public static final JSONStreamAware INCORRECT_ASSET_NAME_LENGTH = incorrect("name", "(length must be in [" + Constants.EC_MIN_ASSET_NAME_LENGTH + ".." + Constants.EC_MAX_ASSET_NAME_LENGTH + "] range)");
    ...
    public static final JSONStreamAware INCORRECT_POLL_NAME_LENGTH = incorrect("name", "(length must be not longer than " + Constants.EC_MAX_POLL_NAME_LENGTH + " characters)");
    public static final JSONStreamAware INCORRECT_POLL_DESCRIPTION_LENGTH = incorrect("description", "(length must be not longer than " + Constants.EC_MAX_POLL_DESCRIPTION_LENGTH + " characters)");
    public static final JSONStreamAware INCORRECT_POLL_OPTION_LENGTH = incorrect("option", "(length must be not longer than " + Constants.EC_MAX_POLL_OPTION_LENGTH + " characters)");
    ...
    public static final JSONStreamAware INCORRECT_ACCOUNT_NAME_LENGTH = incorrect("name", "(length must be less than " + Constants.EC_MAX_ACCOUNT_NAME_LENGTH + " characters)");
    public static final JSONStreamAware INCORRECT_ACCOUNT_DESCRIPTION_LENGTH = incorrect("description", "(length must be less than " + Constants.EC_MAX_ACCOUNT_DESCRIPTION_LENGTH + " characters)");
    ...
    public static final JSONStreamAware INCORRECT_DGS_LISTING_NAME = incorrect("name", "(length must be not longer than " + Constants.EC_MAX_DGS_LISTING_NAME_LENGTH + " characters)");
    public static final JSONStreamAware INCORRECT_DGS_LISTING_DESCRIPTION = incorrect("description", "(length must be not longer than " + Constants.EC_MAX_DGS_LISTING_DESCRIPTION_LENGTH + " characters)");
    public static final JSONStreamAware INCORRECT_DGS_LISTING_TAGS = incorrect("tags", "(length must be not longer than " + Constants.EC_MAX_DGS_LISTING_TAGS_LENGTH + " characters)");
    ...
    public static final JSONStreamAware INCORRECT_CURRENCY_NAME_LENGTH = incorrect("name", "(length must be in [" + Constants.EC_MIN_CURRENCY_NAME_LENGTH + ".." + Constants.EC_MAX_CURRENCY_NAME_LENGTH + "] range)");
    public static final JSONStreamAware INCORRECT_CURRENCY_CODE_LENGTH = incorrect("code", "(length must be in [" + Constants.EC_MIN_CURRENCY_CODE_LENGTH + ".." + Constants.EC_MAX_CURRENCY_CODE_LENGTH + "] range)");
    ...
    public static final JSONStreamAware INCORRECT_CURRENCY_DESCRIPTION_LENGTH = incorrect("description", "(length must not exceed " + Constants.EC_MAX_CURRENCY_DESCRIPTION_LENGTH + " characters)");
    ...
    public static final JSONStreamAware INCORRECT_ADMIN_PASSWORD = incorrect("adminPassword", "(the specified password does not match ec.adminPassword)");
    ...
    public static final JSONStreamAware INCORRECT_TAGGED_DATA_NAME = incorrect("name", "(length must be not longer than " + Constants.EC_MAX_TAGGED_DATA_NAME_LENGTH + " characters)");
    public static final JSONStreamAware INCORRECT_TAGGED_DATA_DESCRIPTION = incorrect("description", "(length must be not longer than " + Constants.EC_MAX_TAGGED_DATA_DESCRIPTION_LENGTH + " characters)");
    public static final JSONStreamAware INCORRECT_TAGGED_DATA_TAGS = incorrect("tags", "(length must be not longer than " + Constants.EC_MAX_TAGGED_DATA_TAGS_LENGTH + " characters)");
    public static final JSONStreamAware INCORRECT_TAGGED_DATA_FILENAME = incorrect("filename", "(length must be not longer than " + Constants.EC_MAX_TAGGED_DATA_FILENAME_LENGTH + " characters)");
    public static final JSONStreamAware INCORRECT_TAGGED_DATA_TYPE = incorrect("type", "(length must be not longer than " + Constants.EC_MAX_TAGGED_DATA_TYPE_LENGTH + " characters)");
    public static final JSONStreamAware INCORRECT_TAGGED_DATA_CHANNEL = incorrect("channel", "(length must be not longer than " + Constants.EC_MAX_TAGGED_DATA_CHANNEL_LENGTH + " characters)");
    ...
    public static final JSONStreamAware INCORRECT_DATA = incorrect("data", "(length must be not longer than " + Constants.EC_MAX_TAGGED_DATA_DATA_LENGTH + " bytes)");
    ...
    public static final JSONStreamAware INCORRECT_ACCOUNT_PROPERTY_NAME_LENGTH = incorrect("property", "(length must be > 0 but less than " + Constants.EC_MAX_ACCOUNT_PROPERTY_NAME_LENGTH + " characters)");
    public static final JSONStreamAware INCORRECT_ACCOUNT_PROPERTY_VALUE_LENGTH = incorrect("value", "(length must be less than " + Constants.EC_MAX_ACCOUNT_PROPERTY_VALUE_LENGTH + " characters)");
    ...
    static {
        JSONObject response = new JSONObject();
        response.put("errorCode", 6);
        response.put("errorDescription", "Property not issued yet");
    ...
    static {
        JSONObject response = new JSONObject();
        response.put("errorCode", 8);
        response.put("errorDescription", "Coin cannot be deleted");
    ...
    static {
        JSONObject response = new JSONObject();
        response.put("errorCode", 8);
        response.put("errorDescription", "Administrator's password is not configured. Please set ec.adminPassword");
    ...
    static {
        JSONObject response = new JSONObject();
        response.put("errorCode", 8);
        response.put("errorDescription", "Poll results no longer available, set ec.processPolls=true and rescan");
    ...
    static {
        ...
        response.put("errorDescription", "Can vote for at most " + Constants.EC_MAX_PHASING_VOTE_TRANSACTIONS + " phased transactions at once");
