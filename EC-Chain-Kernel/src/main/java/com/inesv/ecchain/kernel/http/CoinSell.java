...
public final class CoinSell extends CreateTransaction {

    static final CoinSell instance = new CoinSell();
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws EcException {
        ...
        Mortgaged mortgaged = new Mortgaged.MonetarySystemExchangeSell(coin.getId(), rateNQT, units);
        try {
