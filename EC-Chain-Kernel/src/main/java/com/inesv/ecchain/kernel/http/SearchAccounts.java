...
public final class SearchAccounts extends APIRequestHandler {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws ParameterException {
        ...
        try (H2Iterator<Account.AccountInfo> accounts = Account.searchAccounts(query, firstIndex, lastIndex)) {
