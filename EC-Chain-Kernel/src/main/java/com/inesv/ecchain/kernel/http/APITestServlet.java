...
public class APITestServlet extends HttpServlet {
    ...
    private static final String header1 =
            "<!DOCTYPE html>\n" +
                    ...
                    "           <a class='navbar-brand' href='/test'>EC http API</a>\n" +
                    "       </div>\n" +
                    ...
                    "               <li><a href='https://ecwiki.org/wiki/The_Ec_API' target='_blank' style='margin-left:20px;'>Wiki Docs</a></li>\n" +
                    "           </ul>\n" +
                    "       </div>\n" +
                    "   </div>\n" +
                    "</div>\n" +
    ...
    private static final List<String> allRequestTypes = new ArrayList<>(APIServlet.API_REQUEST_HANDLERS.keySet());
    ...
    static {
        for (Map.Entry<String, APIRequestHandler> entry : APIServlet.API_REQUEST_HANDLERS.entrySet()) {
    ...
    private static String form(HttpServletRequest req, String requestType, boolean singleView, APIRequestHandler requestHandler) {
        ...
        buf.append("<a style='font-weight:normal;font-size:14px;color:#777;' href='https://ecwiki.org/wiki/The_Ec_API#");
        ...
        String formAction = "/test-proxy".equals(path) ? "/ec-proxy" : "/ec";
        ...
        try (PrintWriter writer = resp.getWriter()) {
            ...
            if (requestHandler != null) {
                ...
                for (String type : (taggedTypes != null ? taggedTypes : allRequestTypes)) {
                    requestHandler = APIServlet.API_REQUEST_HANDLERS.get(type);
