...
public final class Token {
    ...
    public static String generateToken(String secretPhrase, byte[] message) {
        ...
        int timestamp = new EcTime.EpochEcTime().getTime();
        ...
        System.arraycopy(Crypto.ecSign(data, secretPhrase), 0, token, 32 + 4, 64);
    ...
    public static Token parseToken(String tokenString, byte[] messageBytes) {
        ...
        boolean isValid = Crypto.ecVerify(signature, data, publicKey, true)
